...
import AddPersonPurchase from './AddPersonPurchase'
...
export default function PurchaseHome() {
	...
	return (
		<div className="App">
			...
			{editDetails && <AddPersonDetailsPurchase details={editDetails} callback={editCallback} />}
		</div>
	)
}
